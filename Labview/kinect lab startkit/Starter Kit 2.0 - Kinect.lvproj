...
<Project Type="Project" LVVersion="10008000">
	...
	<Property Name="NI.Project.Description" Type="Str">This example demonstrates how to control the Robotics Starter Kit 2.0 robot with the Starter Kit API.  The project contains a Simulation target and a Single-Board RIO target.  The VIs in both targets use the same control algorithm.

The Simulation target contains a VI that demonstrates how to use the Starter Kit API in the Robotics Environment Simulator.

The Single-Board RIO target contains a VI that demonstrates how to use the Starter Kit API with a real robot.</Property>
	<Property Name="varPersistentID:{075E618A-4EFA-4BDB-8C92-F64B5389B221}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI5</Property>
	<Property Name="varPersistentID:{0FDA97E2-5D9B-42A1-A5C7-22DCAAB62273}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI4</Property>
	<Property Name="varPersistentID:{106FF0FB-E1C2-43FF-BC9B-29CF8F6E809D}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI30</Property>
	<Property Name="varPersistentID:{12127980-EFE4-41E9-AF30-40E8C5D04F1D}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI10</Property>
	<Property Name="varPersistentID:{1281BF5E-829A-46AA-A039-64B95C7CB6E4}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI16</Property>
	<Property Name="varPersistentID:{1DED49D8-ECB9-422A-9489-B4CD567485D3}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI21</Property>
	<Property Name="varPersistentID:{1F7E83BF-C6C7-4E60-8AF3-1ECC377037B2}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI26</Property>
	<Property Name="varPersistentID:{3393B7DB-D38B-4757-BBEC-7D2B03D2F551}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI25</Property>
	<Property Name="varPersistentID:{375BB732-4001-44BF-87FD-9E9C30E73392}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI1</Property>
	<Property Name="varPersistentID:{3E8686A9-8429-432C-B0FE-0EAE3B39F7A3}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI17</Property>
	<Property Name="varPersistentID:{4075AB43-C025-45AF-B502-6EA98138F0DD}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModB/AO3</Property>
	<Property Name="varPersistentID:{442B55E3-7213-4B6F-A58C-4BB6B2B572FC}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI3</Property>
	<Property Name="varPersistentID:{461A267B-B1F5-4DE4-B426-B58F1588500F}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI20</Property>
	<Property Name="varPersistentID:{49EBBDB6-67AD-4CF5-8532-CFCCA6C59304}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI6</Property>
	<Property Name="varPersistentID:{4BB527FE-B72F-4AC4-8220-8BACE2989165}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI2</Property>
	<Property Name="varPersistentID:{4BDDC381-A8A0-4502-8F93-A902F621A00C}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI27</Property>
	<Property Name="varPersistentID:{538263BA-2EBC-43BC-B0BC-1E82D3BAA595}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI23</Property>
	<Property Name="varPersistentID:{59970A4B-4298-4BAE-8B71-61B0A13F5848}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI22</Property>
	<Property Name="varPersistentID:{66935562-B1DC-4864-849D-615FB986FB23}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI7</Property>
	<Property Name="varPersistentID:{743B6682-FBAB-4B78-97F1-D76A33773AF0}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI0</Property>
	<Property Name="varPersistentID:{759BED7C-0540-4DBB-A2B1-040B71F84AC3}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI13</Property>
	<Property Name="varPersistentID:{9583E9FD-C888-4ADC-B0A2-99D7B3A2FEFB}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI8</Property>
	<Property Name="varPersistentID:{95BAE1A9-BD8C-4293-BC93-04073DFC638C}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI11</Property>
	<Property Name="varPersistentID:{97740D17-B122-41D2-BCD2-217F3E97E5B5}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI12</Property>
	<Property Name="varPersistentID:{9948FE71-1781-4EF2-AFB8-AC67657A0EB6}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModB/AO1</Property>
	<Property Name="varPersistentID:{9B45DAC8-17E6-463C-A424-A3E4AB66BDB7}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModB/AO0</Property>
	<Property Name="varPersistentID:{9C18967C-6C84-4F91-A39A-B046EEC2A090}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI24</Property>
	<Property Name="varPersistentID:{AE3F50A0-912F-461D-AB7C-7A7B5079A546}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI9</Property>
	<Property Name="varPersistentID:{B9974F32-4333-414A-8C82-B5A90B89775C}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI14</Property>
	<Property Name="varPersistentID:{C3956DC4-F32C-40B8-82DC-B4886818E338}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI15</Property>
	<Property Name="varPersistentID:{C4186EC1-1988-4431-936C-18368A7C8638}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModB/AO2</Property>
	<Property Name="varPersistentID:{D27D844A-C18C-434B-82B8-6FB9AEBFB15E}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI19</Property>
	<Property Name="varPersistentID:{D2A4455D-3B04-4045-8F6D-D8B3BDCA881B}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI31</Property>
	<Property Name="varPersistentID:{D56B088E-73E0-4D67-A93E-93AB6F031904}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI18</Property>
	<Property Name="varPersistentID:{DF5A183C-5157-4651-97C8-B9B44D2ABCBF}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI28</Property>
	<Property Name="varPersistentID:{FD7E5140-9E2F-4A40-9CB7-7E2B8B3D87FC}" Type="Ref">/Starter Kit 2.0 sbRIO/Chassis/ModA/AI29</Property>
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Kinect Obstacle Avoidance.vi" Type="VI" URL="../Kinect VIs/Kinect Obstacle Avoidance.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Kinect Heading Data.ctl" Type="VI" URL="../Kinect VIs/Kinect Heading Data.ctl"/>
			<Item Name="Convert to 3D.vi" Type="VI" URL="../Kinect VIs/Convert to 3D.vi"/>
			<Item Name="Slice 3D Cloud.vi" Type="VI" URL="../Kinect VIs/Slice 3D Cloud.vi"/>
			<Item Name="Calculate heading.vi" Type="VI" URL="../Kinect VIs/Calculate heading.vi"/>
			<Item Name="Convert Kinect Depth Image.vi" Type="VI" URL="../Kinect VIs/Convert Kinect Depth Image.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build"/>
	</Item>
	<Item Name="Starter Kit 2.0 sbRIO" Type="RT Single-Board RIO">
		<Property Name="alias.name" Type="Str">Starter Kit 2.0 sbRIO</Property>
		...
		<Item Name="Support VIs" Type="Folder">
			<Item Name="Calculate Driving Direction - Kinect Mod.vi" Type="VI" URL="../Support VIs/Calculate Driving Direction - Kinect Mod.vi"/>
			<Item Name="Drive Towards Gap.vi" Type="VI" URL="../Support VIs/Drive Towards Gap.vi"/>
			<Item Name="Drive Away from Obstacle.vi" Type="VI" URL="../Support VIs/Drive Away from Obstacle.vi"/>
			<Item Name="Kinect Heading Data.ctl" Type="VI" URL="../Kinect VIs/Kinect Heading Data.ctl"/>
		</Item>
		<Item Name="Starter Kit 2.0 Roaming - Kinect.vi" Type="VI" URL="../sbRIO Starter Kit/Starter Kit 2.0 Roaming - Kinect.vi"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="instr.lib" Type="Folder">
				<Item Name="Parallax PING))).lvclass" Type="LVClass" URL="../../../../../../../Program Files (x86)/National Instruments/LabVIEW 2012/instr.lib/Parallax PING)))/HAIOL/Parallax PING))).lvclass"/>
				<Item Name="Parallax PING))) FPGA.lvclass" Type="LVClass" URL="../../../../../../../Program Files (x86)/National Instruments/LabVIEW 2012/instr.lib/Parallax PING)))/HAIOL/FPGA/Parallax PING))) FPGA.lvclass"/>
				<Item Name="DC Motor Controller FPGA.lvclass" Type="LVClass" URL="../../../../../../../Program Files (x86)/National Instruments/LabVIEW 2012/instr.lib/DC Motor Controller/HAIOL/FPGA/DC Motor Controller FPGA.lvclass"/>
				<Item Name="DC Motor Controller.lvclass" Type="LVClass" URL="../../../../../../../Program Files (x86)/National Instruments/LabVIEW 2012/instr.lib/DC Motor Controller/HAIOL/DC Motor Controller.lvclass"/>
				<Item Name="Hitec HS400 Series.lvclass" Type="LVClass" URL="../../../../../../../Program Files (x86)/National Instruments/LabVIEW 2012/instr.lib/Hitec HS400 Series/HAIOL/Hitec HS400 Series.lvclass"/>
				<Item Name="Hitec HS400 Series FPGA.lvclass" Type="LVClass" URL="../../../../../../../Program Files (x86)/National Instruments/LabVIEW 2012/instr.lib/Hitec HS400 Series/HAIOL/FPGA/Hitec HS400 Series FPGA.lvclass"/>
			</Item>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="Starter Kit 2.0 Roaming" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				<Property Name="App_INI_aliasGUID" Type="Str">{26341541-836F-45F6-B09A-C1C666DACAE2}</Property>
				<Property Name="App_INI_GUID" Type="Str">{C9069B85-43B5-4805-BD3C-473A5B602FFF}</Property>
				<Property Name="App_winsec.description" Type="Str">http://www.National Instruments.com</Property>
				<Property Name="Bld_buildSpecName" Type="Str">Starter Kit 2.0 Roaming</Property>
				...
				<Property Name="RTExe_localDestPath" Type="Path">../NI_AB_PROJECTNAME/Startup</Property>
				<Property Name="Source[0].itemID" Type="Str">{9546E938-7D56-4F1D-9388-DE556A445469}</Property>
				<Property Name="Source[0].type" Type="Str">Container</Property>
				<Property Name="Source[1].destinationIndex" Type="Int">0</Property>
				<Property Name="Source[1].itemID" Type="Ref">/Starter Kit 2.0 sbRIO/Starter Kit 2.0 Roaming - Kinect.vi</Property>
				...
				<Property Name="TgtF_targetfileGUID" Type="Str">{C3F6FA01-3517-4BF1-A0C6-1F3E236F40E9}</Property>
